...
<section ng-controller="destaque-controller">
    ...
    <div class="container" id="destaque-produtos-container">
        <div id="destaque-produtos" class="owl-carousel">
            ...
            <div class="row" style="margin-top: 10px;" ng-repeat="produto in produtos">

                <div class="col-sm-6 col-imagem">
                    <a href="produto-{{produto.id_prod}}"></a>
                    <img src="assets/produtos/{{produto.foto_principal}}" alt="{{produto.nome_prod_longo}}">
                </div>
                ...
                <div class="col-sm-6 col-descricao">
                    ...
                    <div class="box-valor">
                        ...
                        <div class="text-total text-arial-cinza">total a prazo de R$ {{produto.total}}</div>
                    </div>
            ...
            <div class="col-md-3" ng-repeat="produto in buscados">
                ...
                <div class="box-produto-info">
                    <a href="produto-{{produto.id_prod}}">
                        <img src="assets/produtos/{{produto.foto_principal}}" alt="{{produto.nome_prod_longo}}" class="produto-img">
